                    ...
                    <div class="col-12">
                        <div class="about-wrapper text-center">
                            ...
                            <div class="promo-video">
                                <img src="/src/assets/images/about/promo-video-img.webp" alt="">
                                <a href="https://youtu.be/Hx64uvCA_zQ" class="venobox overlay-box" data-vbtype="video"><span
            ...
            <div class="container">
                ...
                <div class="row mb-n-30px">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-lm-30px mb-lg-30px mb-md-30px">
                        ...
                        <div class="team-wrapper ">
                            <div class="team-image overflow-hidden">
                                <img src="/src/assets/images/team/1.webp" alt="">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 mb-lm-30px mb-lg-30px mb-md-30px">
                        ...
                        <div class="team-wrapper">
                            <div class="team-image overflow-hidden">
                                <img src="/src/assets/images/team/2.webp" alt="">
                                <ul class="team-social d-flex">
                                    <li>
                                        <a class="m-0" title="Twitter" target="_blank" rel="noopener noreferrer" href="#"><i class="fa fa-facebook"
                                            aria-hidden="true"></i></a>
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-6 col-md-6 mb-lm-30px ">
                        ...
                        <div class="team-wrapper">
                            <div class="team-image overflow-hidden">
                                <img src="/src/assets/images/team/3.webp" alt="">
                                <ul class="team-social d-flex">
                                    <li>
                                        <a class="m-0" title="Twitter" target="_blank" rel="noopener noreferrer" href="#"><i class="fa fa-facebook"
                                            aria-hidden="true"></i></a>
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="testi-inner">
                                        ...
                                        <div class="testi-author">
                                            <div class="author-image">
                                                <img class="img-responsive" src="/src/assets/images/testimonial/1.png" alt="">
                                            </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="testi-inner">
                                        ...
                                        <div class="testi-author">
                                            <div class="author-image">
                                                <img class="img-responsive" src="/src/assets/images/testimonial/2.png" alt="">
                                            </div>
                                            <div class="author-name">
                                                <h4 class="name">Regan Rosen<span>Client</span></h4>
                                            </div>
