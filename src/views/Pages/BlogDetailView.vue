                        ...
                        <div class="blog-posts">
                            <div class="single-blog-post blog-grid-post">
                                <div class="blog-image single-blog">
                                    <img class="img-fluid h-auto border-radius-10px" src="/src/assets/images/blog-image/single-blog.webp" alt="blog" />
                                </div>
                            ...
                            <div class="another-post">
                                ...
                                <div class="image-side">
                                    <img src="/src/assets/images/blog-image/side-image.webp" alt="">
                                </div>
                            </div>
                        ...
                        <div class="blog-nav">
                            <div class="blog-nav-wrap">
                                <div class="nav-left d-flex justify-content-start align-items-center">
                                    <a class="nav-img" href="blog-single-left-sidebar.html"><img src="/src/assets/images/blog-image/post-1.webp" alt="" /><i class="fa fa-angle-left"></i></a>
                                ...
                                <div class="nav-right d-flex justify-content-end flex-row-reverse align-items-center">
                                    <a class="nav-img" href="blog-single-left-sidebar.html"><img src="/src/assets/images/blog-image/post-2.webp" alt="" /><i class="fa fa-angle-right"></i></a>
                                    <div class="media-side">
                                        <span class="date"><i class="fa fa-calendar" aria-hidden="true"></i>27  jun, 2022</span>
                                        <h5><a href="blog-single-left-sidebar.html">Lorem ipsum dolorl
                                                amet conse adip</a>
                            ...
                            <div class="review-wrapper">
                                <div class="single-review" data-aos="fade-up" data-aos-delay="200">
                                    <div class="review-img">
                                        <img src="/src/assets/images/blog-image/comment-img-1.webp" alt="" />
                                    </div>
                                ...
                                <div class="single-review child-review" data-aos="fade-up" data-aos-delay="200">
                                    <div class="review-img">
                                        <img src="/src/assets/images/blog-image/comment-img-2.webp" alt="" />
                                    </div>
                                    <div class="review-content">
                                        <div class="review-top-wrap">
                                            <div class="review-left">
                                ...
                                <div class="single-review" data-aos="fade-up" data-aos-delay="200">
                                    <div class="review-img">
                                        <img src="/src/assets/images/blog-image/comment-img-3.webp" alt="" />
                                    </div>
                                    <div class="review-content">
                                        <div class="review-top-wrap">
                                            <div class="review-left">
