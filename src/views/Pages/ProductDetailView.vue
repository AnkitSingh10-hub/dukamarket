                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12 mb-lm-30px mb-md-30px mb-sm-30px">
                        ...
                        <div class="swiper-container mt-20px zoom-thumbs slider-nav-style-1 small-nav swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events swiper-container-free-mode swiper-container-thumbs">
                            <div class="swiper-wrapper" id="swiper-wrapper-a6d9aebd9102910d84" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                ...
                                <div class="swiper-slide swiper-slide-visible swiper-slide-next" role="group" aria-label="2 / 5" style="width: 121px; margin-right: 18px;">
                                    <img class="img-responsive m-auto" src="/src/assets/images/product-image/small-image/2.webp" alt="">
                                </div>
                                <div class="swiper-slide swiper-slide-visible" role="group" aria-label="3 / 5" style="width: 121px; margin-right: 18px;">
                                    <img class="img-responsive m-auto" src="/src/assets/images/product-image/small-image/3.webp" alt="">
                                </div>
                                <div class="swiper-slide" role="group" aria-label="4 / 5" style="width: 121px; margin-right: 18px;">
                                    <img class="img-responsive m-auto" src="/src/assets/images/product-image/small-image/4.webp" alt="">
                                </div>
                                <div class="swiper-slide" role="group" aria-label="5 / 5" style="width: 121px; margin-right: 18px;">
                                            ...
                                            <div class="review-wrapper">
                                                <div class="single-review">
                                                    <div class="review-img">
                                                        <img src="/src/assets/images/review-image/1.png" alt="" />
                                                    </div>
                                                ...
                                                <div class="single-review child-review">
                                                    <div class="review-img">
                                                        <img src="/src/assets/images/review-image/2.png" alt="" />
                                                    </div>
                                                    <div class="review-content">
                                                        <div class="review-top-wrap">
                                                            <div class="review-left">
